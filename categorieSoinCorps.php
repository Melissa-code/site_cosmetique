...
<div id="product-grid">
    <div class="txt-heading"><h3>Produits de la categorie soin de corps & douche</h3></div>
    <?php

    $product_array = $db_handle->runQuery("SELECT nProduit, nomProduit, prixProduit, descProduit, Categorie.descCategorie as description FROM Produit, Categorie WHERE Produit.idCategorie=Categorie.idCategorie AND Categorie.nomCategorie='soin corps & douche'");
