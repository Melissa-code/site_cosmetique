    ...
    <form action="modifierUnProduit.php" method="post">
        ...
        <div>
            ...
            <select name="codePromo" id="codePromo">
                <option><?php echo $options_promotion; ?></option>
            ...
            <textarea rows="10" cols="30" name="descProduit" placeholder="Description de produit"  id="descProduit"><?php echo $desc; ?></textarea><br>
